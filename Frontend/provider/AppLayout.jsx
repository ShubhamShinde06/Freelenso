  ...
  return (
    <>
      ...
      <main className="flex-1 w-full h-screen overflow-hidden">
        <div className="lg:mt-4 lg:mr-2 p-2 m-1 rounded-lg dark:bg-[#0a0a0a]  flex flex-col  h-full shadow-inner">
          {!hideLayout && (
          ...
          <div className="flex-1 overflow-auto custom-scroll px-1 py-4">
            {children}
          </div>
        </div>
      </main>
